...
namespace Pi.Replicate.Test.Shared
{
	...
	public class PathBuilderTest
	{
		...
		public void BuildPath_BaseIsEmpty_PathShouldBeRelative()
		{
			...
			File file = File.Build(new System.IO.FileInfo(System.IO.Path.Combine(System.IO.Directory.GetCurrentDirectory(), "FileFolder", "test1.txt")), System.Guid.Empty, @"D:\Test",ReadOnlyMemory<byte>.Empty);
		...
		public void BuildPath_File_PathIsBuild()
		{
			...
			File file = File.Build(new System.IO.FileInfo(System.IO.Path.Combine(rootPath, "FileFolder", "test1.txt")), System.Guid.Empty, pathBuilder.BasePath,ReadOnlyMemory<byte>.Empty);
			var filePath = pathBuilder.BuildPath(file.Path);
